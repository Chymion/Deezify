...
public class utilisateur {
    ...
    public utilisateur( String prenom, String nom, String pseudo, String email, String password ) throws Exception {
        ...
        /*
         * ResultSet rs = null; try { rs = db.displayData(
         * "SELECT NomUtilisateur FROM utilisateur" ); } catch ( SQLException e
         * ) { e.printStackTrace(); }
         * 
         * try { System.out.println( "Affichage des donnees : " ); while (
         * rs.next() ) System.out.println( rs.getString( "NomUtilisateur" ) ); }
